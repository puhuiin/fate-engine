...
export default function Report() {
  ...
  const layers: Array<{
  ...
  }> = [
    {
      ...
      ready: !!data.l1,
      locked: false,
      el: data.l1 ? <Layer1 l1={data.l1} /> : undefined,
    },
    {
      layer: 2,
      name: LAYER_NAMES[1],
      ready: !!data.l2,
      locked: false,
      el: data.l2 ? <Layer2 l2={data.l2} /> : undefined,
    },
    {
      layer: 3,
      name: LAYER_NAMES[2],
      ready: !!data.l3,
      locked: false,
      el: data.l3 ? <Layer3 l3={data.l3} /> : undefined,
    },
    {
      layer: 4,
      name: LAYER_NAMES[3],
      ready: !!data.l4,
      locked: !unlocked,
      el: data.l4 ? <Layer4 l4={data.l4} /> : undefined,
    },
    {
      layer: 5,
      name: LAYER_NAMES[4],
      ready: !!data.l5,
      locked: !unlocked,
      el: data.l5 ? <Layer5 l5={data.l5} /> : undefined,
    },
    {
      layer: 6,
      name: LAYER_NAMES[5],
      ready: !!data.l6,
      locked: !unlocked,
      el: data.l6 ? <Layer6 l6={data.l6} risks={risks} /> : undefined,
    },
    {
      layer: 7,
      name: LAYER_NAMES[6],
      ready: !!data.l7,
      locked: !unlocked,
      el: data.l7 ? <Layer7 l7={data.l7} /> : undefined,
    },
    {
      layer: 8,
      name: LAYER_NAMES[7],
      ready: !!data.l8,
      locked: !unlocked,
      el: data.l8 ? <Layer8 l8={data.l8} plans={plans} onToggle={togglePlan} /> : undefined,
    },
    {
      layer: 9,
      name: LAYER_NAMES[8],
      ready: !!data.l9,
      locked: !unlocked,
      el: data.l9 ? <Layer9 l9={data.l9} /> : undefined,
    },
  ];
    ...
    <div className="report">
      <div className="card">
        ...
        <button
          ...
          onClick={() => exportText({ data, unlocked, risks, recordId })}
        >
          {copied ? '已复制报告 ✓' : '复制报告文本'}
        </button>
